			...
			<div class="col-md-12">
				<div class="panel panel-primary" data-collapsed="0">
					...
					<div class="panel-body">
						{!! Form::open(array('route' => 'currencies.store','method'=>'POST', 'role' => 'form', 'class' => 'form-horizontal form-groups-bordered validate')) !!}
							...
							<div class="form-group {{ $errors->has('from_location') ? ' has-error' : '' }}">
								...
								<div class="col-sm-5">
									<div class="input-group minimal">
										...
										{!! Form::select('from_location', ['' => 'Select Country'] + $countryList->toArray(), null, ['class' => 'form-control select2', 'id' => 'from_location', 'autocomplete' => 'off']) !!}
									</div>
	...
	<script>
		$(document).ready(function(){
			...
			$("#company_id").change(function(event) {
				...
				var countrySelect = $('#from_location');
				$.ajax({
					type: 'GET',
