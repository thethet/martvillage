...
<head>
	...
	<meta charset="utf-8">
	<title>Sales Report By Cash</title>
			...
			<table class="table table-bordered responsive zawgyi">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-right">{{ number_format($totalSalesCash, 2) }}</td>
						<td class="text-right">{{ number_format($totalDiscountCash, 2) }}</td>
						<td class="text-right">{{ number_format($totalNetSalesCash, 2) }}</td>
					</tr>
				</tbody>
			</table>
		</div>
