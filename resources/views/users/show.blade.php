							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<div class="input-group minimal">
										...
										{!! Form::select('gender', ['' => 'Select Gender'] + Config::get('myVars.Gender'), null, ['class' => 'select2', 'id' => 'gender', 'disabled']) !!}
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<div class="input-group minimal">
										...
										{!! Form::select('marital_status', ['' => 'Select Marital Status'] + Config::get('myVars.MaritalStatus'), null, ['class' => 'select2', 'disabled']) !!}
									</div>
								</div>
							</div>
								...
								<div class="col-sm-5">
									<div class="input-group minimal">
										...
										@if (Auth::user()->hasRole('administrator') || Auth::user()->hasRole('owner'))
											{!! Form::select('role', ['' => 'Select Role'] + $roleList->toArray(), $userRole, ['class' => 'select2', 'disabled']) !!}
										@else
											{!! Form::select('roles', ['' => 'Select Role'] + $roleList->toArray(), $userRole, ['class' => 'select2', 'disabled']) !!}
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<div class="input-group minimal">
										...
										{!! Form::select('country_id', ['' => 'Select Country'] + $countryList->toArray(), null, ['id'=>'country_id', 'class' => 'select2', 'disabled']) !!}
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<div class="input-group minimal">
										...
										{!! Form::select('state_id', ['' => 'Select State/City'] + $stateList->toArray(), null, ['id'=>'state_id', 'class' => 'select2', 'disabled']) !!}
									</div>
								</div>
							</div>
