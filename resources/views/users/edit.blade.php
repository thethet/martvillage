							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<div class="input-group minimal">
										...
										{!! Form::select('nric_code_id', ['' => 'Code'] + $nricCodeList->toArray(), null, ['class' => 'form-control', 'id' => 'nric_code', 'data-allow-clear' => 'true', 'autocomplete' => 'off']) !!}
									</div>
								</div>
								...
								<div class="col-sm-2">
									<div class="input-group minimal">
										<span class="input-group-addon"><i class="entypo-vcard"></i></span>
										{!! Form::select('nric_township_id', ['' => 'Township'] + $nricTownshipList->toArray(), null, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'nric_township', 'autocomplete' => 'off']) !!}
									</div>
								</div>
								...
								<div class="col-sm-5">
									<div class="input-group minimal">
										...
										@if (Auth::user()->hasRole('administrator') || Auth::user()->hasRole('owner'))
											{!! Form::select('role', ['' => 'Select Role'] + $roleList->toArray(), $userRole, ['class' => 'form-control', 'autocomplete' => 'off']) !!}
										@else
											{!! Form::select('roles', ['' => 'Select Role'] + $roleList->toArray(), $userRole, ['class' => 'form-control', 'disabled' => true, 'autocomplete' => 'off']) !!}
