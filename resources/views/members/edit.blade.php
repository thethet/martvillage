...
@section('site-title')
	...
	<div class="col-md-8 site-header">Member Profile</div>
@stop

@section('main')
{!! Form::model($member, ['method' => 'PATCH','route' => ['members.update', $member->id], 'id' => 'member-form', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
		...
		<div class="row">
			<div class="col col-md-7">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						{!! Form::text('email', null, array('placeholder' => 'Please Enter Email','class' => 'form-control', 'id' => 'email', 'readonly' => true)) !!}
						@if ($errors->has('email'))
							<span class="required">
	...
	<div class="footer-menu">
		<div class="footer-content">
			...
			<div class="menu-icon">
				<a href="#" id="reset" onclick="document.getElementById('member-form').reset();">
			...
			<div class="menu-icon">
				<a href="#" id="add" onclick="document.getElementById('member-form').submit();">
