							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<div class="input-group minimal">
										...
										{!! Form::select('gender', ['' => 'Select Gender'] + Config::get('myVars.Gender'), null, ['class' => 'select2', 'id' => 'gender', 'autocomplete' => 'off', 'disabled']) !!}
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<div class="input-group minimal">
										...
										{!! Form::select('marital_status', ['' => 'Select Marital Status'] + Config::get('myVars.MaritalStatus'), null, ['class' => 'select2', 'autocomplete' => 'off', 'disabled']) !!}
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<div class="input-group minimal">
										...
										{!! Form::select('member_offers_id', ['' => 'Select Membership'] + $offerList->toArray(), null, ['class' => 'select2', 'autocomplete' => 'off', 'disabled']) !!}
									</div>
								</div>
							</div>
